        ...
        NetworkService.getInstance()
                ...
                .enqueue(new Callback<List<Currency>>() {
                    ...
                    public void onResponse(@NonNull Call<List<Currency>> call, @NonNull Response<List<Currency>> response) {
                        ...
                        Toast.makeText(intasnce,"Продавши" + count + spinner.getSelectedItem() + " ви отримаєте"+ selled + "UAH", Toast.LENGTH_LONG).show();
                    }
        ...
        NetworkService.getInstance()
                ...
                .enqueue(new Callback<List<Currency>>() {
                    ...
                    public void onResponse(@NonNull Call<List<Currency>> call, @NonNull Response<List<Currency>> response) {
                        ...
                        Toast.makeText(intasnce, "Заплативши" + count + "UAH" + " ви отримаєте" + selled + spinner.getSelectedItem() , Toast.LENGTH_LONG).show();
                    }
